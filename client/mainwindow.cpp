    ...
    : QWidget(parent)
{
    ...
    showAllClientsButton = new QPushButton(tr("Show All Clients"));
    connect(showAllClientsButton, &QPushButton::clicked,
            this, &MainWindow::showClients);
    ...
    startTimeLabel = new QLabel("Start date:");
    endTimeLabel = new QLabel("End date:");
    ...
    vBoxLayout->addWidget(showAllClientsButton);
...
void MainWindow::showClients()
{
    ...
    Request request{
                    this->clientIdLineEdit->text().toInt(),
                    "SHOW_ALL_CLIENTS", "", "", DateTime{}, DateTime{}, -1};

    senderThread.sendRequest(request);

    showAllClientsButton->setEnabled(true);
}
